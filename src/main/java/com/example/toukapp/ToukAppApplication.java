...
public class ToukAppApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            stm.executeUpdate("insert into tickettypes (TypeID, Name, Price) values (1, 'child', 12.5);");
            stm.executeUpdate("insert into tickettypes (TypeID, Name, Price) values (2, 'student', 18);");
            stm.executeUpdate("insert into tickettypes (TypeID, Name, Price) values (3, 'adult', 25);");
